...
const FALLBACK_AVATAR = '/default.jpg';
...
const Header = () => {
  ...
  useEffect(() => {
    if (user) {
      ...
      setAvatarUrl(url || FALLBACK_AVATAR);
      
      // Preload the image
      const img = new Image();
      img.src = url || FALLBACK_AVATAR;
      img.onload = () => {
      ...
      img.onerror = () => {
        ...
        if ((url || FALLBACK_AVATAR) !== FALLBACK_AVATAR) {
                  ...
                  <div className="relative">
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        // Use /default.jpg fallback
                        console.log('Using /default.jpg fallback avatar');
                        setAvatarUrl(FALLBACK_AVATAR);
                      }}
                    />
                  </div>
